...
words = {'Colours': '''red orange yellow green blue indigo violet white black
          brown'''.split(),
         ...
         'Animals': '''bat bear beaver cat cougar crab deer dog sonkey duck eagle
          fish frog goat leech lion lizzard monkey moose mouse otter owl panda
